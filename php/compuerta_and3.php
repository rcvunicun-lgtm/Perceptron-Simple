...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/compuerta_and3.css">
    </head>
    <body>
        <header>
        ...
        <section class="principal">
            <section class="cuerpo1">
                <div id="titulo_tabla">
                  <h1>TABLA PERCEPTRON COMPUERTA "AND" 3 ENTRADAS</h1>
                </div>
                <div id="cuerpo_tabla">
                <table border="1">
                        <tr>
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                            $y=(($_SESSION['p1']*$entradas[$fila][0])+($_SESSION['p2']*$entradas[$fila][1])+($_SESSION['p3']*$entradas[$fila][2]))-$_SESSION['umbral'];
                                            echo $y; 
                                            if ($y>=0) 
                                            {
                                                $fx =1;
            ...
            <section class="cuerpo2">
                ...
                <a href="compuerta_and3.php"type="buton"class="btn btn-primary">RECALCULAR</a>

                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button tyle="buton" class="close" data-dismiss="modal"
                            ...
                            <div class="modal-body">
                                <table class="compuerta_and">
                                    ...
                                    <tr>
                                        <td><a href="compuerta_and2.php" type="buton" class="btn btn-primary">IR AL
                                                PERCEPTRON</a></td>
                                        <td><a href="compuerta_and3.php" type="buton" class="btn btn-primary">IR AL
                                                PERCEPTRON</a></td>
                                        <td><a href="compuerta_and4.php" type="buton" class="btn btn-primary">IR AL
                                                PERCEPTRON</a></td>
                                    </tr>
                                </table>
                            </div>

...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/compuerta_or_4.css">
    </head>
    <body>
        <header>
        ...
        <section class="principal">
            <section class="cuerpo1">
                <div id="titulo_tabla">
                  <h1>TABLA PERCEPTRON COMPUERTA "OR" 4 ENTRADAS</h1>
                </div>
                <div id="cuerpo_tabla">
                <table border="1">
                        <tr>
            ...
            <section class="cuerpo2">
                ...
                <a href="compuerta_or4.php"type="buton"class="btn btn-primary">RECALCULAR</a>

...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/compuerta_nor_3.css">
    </head>
    <body>
        <header>
        ...
        <section class="principal">
            <section class="cuerpo1">
                <div id="titulo_tabla">
                  <h1>TABLA PERCEPTRON COMPUERTA NOR 3 ENTRADAS</h1>
                </div>
                <div id="cuerpo_tabla">
                <table border="1">
                        <tr>
            ...
            <section class="cuerpo2">
                ...
                <a href="compuerta_nor3.php"type="buton"class="btn btn-primary">RECALCULAR</a>
